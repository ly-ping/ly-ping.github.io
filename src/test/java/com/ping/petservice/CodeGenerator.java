...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/pservice?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8");
...
//                }
        ...
        if(scanner("是否继承基类").equalsIgnoreCase("y")){
            strategy.setSuperEntityClass("com.ping.petservice.entity.BaseEntity");
            //写于父类的公共字段
